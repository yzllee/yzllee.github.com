...
Container$$module$cn$ucai$game2d$display$Container.prototype.internal_onClick=function(a){if(this.isEnabled()&&this.isVisible())for(var b=0;b<this._children.length;b++)this._children[b].internal_onClick(a)};Container$$module$cn$ucai$game2d$display$Container.prototype.internal_enterFrame=function(a){for(var b=0;b<this._children.length;b++)this._children[b].internal_enterFrame(a);module$cn$ucai$game2d$display$Display["default"].prototype.internal_enterFrame.call(this,a)};
var $jscompDefaultExport$$module$cn$ucai$game2d$display$Container=Container$$module$cn$ucai$game2d$display$Container;module$cn$ucai$game2d$display$Container["default"]=$jscompDefaultExport$$module$cn$ucai$game2d$display$Container;var module$cn$ucai$game2d$anim$PropertyAnim={},PropertyAnim$$module$cn$ucai$game2d$anim$PropertyAnim=function(a,b,c,d,e,f){this._target=a;this._propertyName=b;this._from=c;this._to=d;this._frames=e;this._completeHandler=f;this._enterFrameHander=this.enterFrameHandler.bind(this);this._speed=(this._to-this._from)/this._frames;this._frameIndex=0;this._running=!1};
PropertyAnim$$module$cn$ucai$game2d$anim$PropertyAnim.prototype.start=function(){this._running||(this._frameIndex=0,this._target[this._propertyName]=this._from,this._target.addEventListener(module$cn$ucai$game2d$events$G2DEvent["default"].ENTER_FRAME,this._enterFrameHander),this._running=!0)};
PropertyAnim$$module$cn$ucai$game2d$anim$PropertyAnim.prototype.enterFrameHandler=function(a){this._target[this._propertyName]+=this._speed;this._frameIndex++;this._frameIndex>=this._frames&&(this._target.removeEventListener(module$cn$ucai$game2d$events$G2DEvent["default"].ENTER_FRAME,this._enterFrameHander),this._running=!1,this._target[this._propertyName]=this._to,this._completeHandler&&this._completeHandler())};module$cn$ucai$game2d$anim$PropertyAnim["default"]=PropertyAnim$$module$cn$ucai$game2d$anim$PropertyAnim;var module$cn$ucai$game2d$app$Game2dApp={},Game2dApp$$module$cn$ucai$game2d$app$Game2dApp=function(a,b){module$cn$ucai$game2d$display$Container["default"].call(this);this._enterFrameEvent=new module$cn$ucai$game2d$events$G2DEvent["default"](module$cn$ucai$game2d$events$G2DEvent["default"].ENTER_FRAME);this._stageWidth=a;this._stageHeight=b;this._canvas=document.createElement("canvas");this._canvas.width=this._stageWidth;this._canvas.height=this._stageHeight;this._context2d=this._canvas.getContext("2d");
...
module$cn$ucai$game2d$app$Game2dApp["default"]=$jscompDefaultExport$$module$cn$ucai$game2d$app$Game2dApp;var module$cn$ucai$demos$cardmemory$Card={},Card$$module$cn$ucai$demos$cardmemory$Card=function(a,b,c){module$cn$ucai$game2d$display$Container["default"].call(this);this._num=a;this._faceA=new module$cn$ucai$game2d$display$Container["default"];this._faceABg=new module$cn$ucai$game2d$display$Rectangle["default"](b,c,"red");this._faceA.addChild(this._faceABg);this._text=new module$cn$ucai$game2d$display$Text["default"](""+a,30);this._faceA.addChild(this._text);this.addChild(this._faceA);this._faceB=
new module$cn$ucai$game2d$display$Rectangle["default"](b,c,"blue");this.addChild(this._faceB);this.showFaceA()};$jscomp.inherits(Card$$module$cn$ucai$demos$cardmemory$Card,module$cn$ucai$game2d$display$Container["default"]);Card$$module$cn$ucai$demos$cardmemory$Card.prototype.showFaceA=function(){this._faceA.setVisible(!0);this._faceB.setVisible(!1)};Card$$module$cn$ucai$demos$cardmemory$Card.prototype.showFaceB=function(){this._faceA.setVisible(!1);this._faceB.setVisible(!0)};
Card$$module$cn$ucai$demos$cardmemory$Card.prototype.turnToFaceB=function(){var a=this;this._faceA.isVisible()&&(new module$cn$ucai$game2d$anim$PropertyAnim["default"](this._faceA,"scaleX",1,0,20,function(){a.showFaceB();(new module$cn$ucai$game2d$anim$PropertyAnim["default"](a._faceB,"scaleX",0,1,20)).start()})).start()};Card$$module$cn$ucai$demos$cardmemory$Card.prototype.getNum=function(){return this._num};var $jscompDefaultExport$$module$cn$ucai$demos$cardmemory$Card=Card$$module$cn$ucai$demos$cardmemory$Card;
module$cn$ucai$demos$cardmemory$Card["default"]=$jscompDefaultExport$$module$cn$ucai$demos$cardmemory$Card;var module$cn$ucai$demos$cardmemory$CardMemory={},CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory=function(){module$cn$ucai$game2d$app$Game2dApp["default"].call(this,400,300);document.body.appendChild(this.getDom());this._points=[];this._cardHeight=this._cardWidth=50;this._currentNum=1;this._cardNumber=3;this.restartGame()};$jscomp.inherits(CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory,module$cn$ucai$game2d$app$Game2dApp["default"]);
CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory.prototype.restartGame=function(){this._currentNum=1;this.removeAllChildren();this.generatePoints();this.addCards();this._cardNumber+=2};
CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory.prototype.addCards=function(){for(var a,b,c,d=1;d<=this._cardNumber;d++)a=new module$cn$ucai$demos$cardmemory$Card["default"](d,this._cardWidth-2,this._cardHeight-2),c=Math.floor(Math.random()*this._points.length),b=this._points[c],this._points.splice(c,1),a.x=b.x,a.y=b.y,a.addEventListener("click",this.cardClickedHandler.bind(this)),this.addChild(a)};
CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory.prototype.cardClickedHandler=function(a){if(this._currentNum==a.getTarget().getNum()){this.removeChild(a.getTarget());if(1==this._currentNum)for(a=0;a<this.getChildrenCount();a++)this.getChildAt(a).turnToFaceB();this._currentNum++;0==this.getChildrenCount()&&(alert("\u6210\u529f\u4e86,\u8fdb\u5165\u4e0b\u4e00\u5173"),this.restartGame())}else alert("\u70b9\u9519\u4e86,\u6e38\u620f\u5c06\u91cd\u65b0\u5f00\u59cb"),this._cardNumber=3,this.restartGame()};
CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory.prototype.generatePoints=function(){for(var a=this._points.length=0;8>a;a++)for(var b=0;6>b;b++)this._points.push({x:this._cardWidth*a,y:this._cardHeight*b})};new CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory;var $jscompDefaultExport$$module$cn$ucai$demos$cardmemory$CardMemory=CardMemory$$module$cn$ucai$demos$cardmemory$CardMemory;module$cn$ucai$demos$cardmemory$CardMemory["default"]=$jscompDefaultExport$$module$cn$ucai$demos$cardmemory$CardMemory;
